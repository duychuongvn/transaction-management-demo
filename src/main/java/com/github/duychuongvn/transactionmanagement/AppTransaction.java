...
public class AppTransaction {
    public static void main(String[] args) {
        ...
        final BankService transactionAndExceptionBankService = (BankService) context.getBean("transactionAndExceptionBankService");
        final BankService transactionConcurrentBankService = (BankService) context.getBean("transactionConcurrentBankService");
        transferAToBAndExceptionOccur(userManager, transactionAndExceptionBankService);
        transferAToBAndConcurrentOccur(userManager, transactionConcurrentBankService);
